...
**版本**: v0.8.1-release | **日期**: 2026-07-10 | **状态**: 已发布
...
| 2 | 城投债(LGFV) | 24 | 24 / 20.08 = 1.195 | 超级传染者 |
...
|------|-----------------|--------------|-------------|-----------|
| 城投债(LGFV) | 35.0% | 1.195 | 41.83% | 37.50% |
...
| v0.8.1-release（当前） | 门禁加固与晋升机制（本框架与阈值无变更）：.gitattributes 强制 LF·CI 上线·promote.py 晋升脚本 |
...
*本文档应与《双轨分析方法论》(v0.8.1-release)、《传染矩阵》(v0.8.1-release)、《五维集中度分析框架》(v0.8.1-release)、《展望监控框架》配合使用。系统性预警框架是引擎M4组合风控层的顶层仪表盘，为分散的行业信号提供统一的系统性风险读数。*

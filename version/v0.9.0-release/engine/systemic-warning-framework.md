...
**版本**: v0.9.0-release | **日期**: 2026-07-10 | **状态**: 已发布
...
*本文档应与《双轨分析方法论》(v0.9.0-release)、《传染矩阵》(v0.9.0-release)、《五维集中度分析框架》(v0.9.0-release)、《展望监控框架》配合使用。系统性预警框架是引擎M4组合风控层的顶层仪表盘，为分散的行业信号提供统一的系统性风险读数。*

...
|---------|---------------|-------------|
| 8.0-10.0 | AAA/AA+/AA/AA- | 稳健 |
| 7.0-7.9 | A+/A/A- | 良好 |
| 6.0-6.9 | BBB+/BBB/BBB- | 中等 |
| 5.0-5.9 | BB+/BB/BB- | 偏弱 |
| 3.0-4.9 | B+/B/B- | 脆弱 |
| 0-2.9 | CCC/D | 危险 |
...
| 5.0-6.0 (BBB) | 1 | 1.5 | 1.5 | 2.0 | 3.0 |
| 3.0-5.0 (B/BB) | 2 | 2.5 | 2.5 | 3.0 | 3.0 |
...
| 5.0-6.0 → 1分 | 对应BBB级，属于投资级下沿，行业开始出现脆弱性，但不构成系统性威胁 |
| 3.0-5.0 → 2分 | 对应BB/B级，属于投机级，行业面临实质性挑战，需要纳入风险计数 |
...
|------|-------------|------------------|------|-------|---------|
| 煤炭(注) | 3.0-4.0 (BB/B+) | 2 | 负面 | 🟡(关注) | 3.0 |
| 城投债(LGV) | 5.5-6.0 (BBB/BB+) | 1 | 稳定 | 🟢(平静) | 1.0 |
| 交通运输 | 5.5-6.0 (BBB/BB+) | 1 | 稳定 | 🟢(平静) | 1.0 |
| 房地产 | 5.0-6.0 (BB+/BBB) | 1 | 稳定 | 🟢(平静) | 1.0 |
| 光伏/储能 | 5.5-6.0 (BBB) | 1 | 稳定 | 🟢(平静) | 1.0 |
| 半导体/集成电路 | 6.0-7.0 (A-/BBB+) | 0 | 正面 | 🟢(平静) | 0 |
| 高端装备 | 6.0-7.0 (A-/BBB+) | 0 | 稳定 | 🟢(平静) | 0 |
| 生物医药 | 6.5-7.5 (A-/A) | 0 | 正面 | 🟢(平静) | 0 |
| 医疗器械 | 6.0-7.0 (A-/BBB+) | 0 | 稳定 | 🟢(平静) | 0 |
| 新能源汽车 | 5.5-6.5 (BBB/A-) | 0 | 稳定 | 🟢(平静) | 0 |
| 数据中心 | 6.5-7.0 (A-/A) | 0 | 正面 | 🟢(平静) | 0 |
...
| 行业 | 轨道A评分(估) | 行业风险得分(基准) | 展望 | 轨道B | 风险得分 |
|------|-------------|------------------|------|-------|---------|
| 房地产(注) | 3.5-4.5 (BB/B+) | 2 | 负面 | 🟠(异常) | 3.0 |
| 建筑/建材(注) | 4.0-5.0 (BB+/B+) | 2 | 负面 | 🟡(关注) | 2.5 |
| 城投债(LGV) | 5.0-5.5 (BB+/BBB) | 1 | 负面 | 🟡(关注) | 2.0 |
| 交通运输 | 5.5-6.0 (BBB) | 1 | 稳定 | 🟢(平静) | 1.0 |
| 光伏/储能 | 6.0-7.0 (A-/BBB+) | 0 | 稳定 | 🟢(平静) | 0 |
| 半导体/集成电路 | 6.5-7.5 (A) | 0 | 正面 | 🟢(平静) | 0 |
| 高端装备 | 6.0-7.0 (A-/BBB+) | 0 | 稳定 | 🟢(平静) | 0 |
| 生物医药 | 6.5-7.5 (A) | 0 | 正面 | 🟢(平静) | 0 |
| 医疗器械 | 6.0-7.0 (A-/BBB+) | 0 | 稳定 | 🟢(平静) | 0 |
| 新能源汽车 | 5.5-6.5 (BBB/A-) | 0 | 稳定 | 🟢(平静) | 0 |
| 数据中心 | 6.5-7.0 (A-/A) | 0 | 正面 | 🟢(平静) | 0 |
| 食品饮料 | 7.0-7.5 (A) | 0 | 稳定 | 🟢(平静) | 0 |
| 纺织服装 | 6.0-6.5 (BBB+) | 0 | 稳定 | 🟢(平静) | 0 |
| 传媒/互联网 | 6.0-7.0 (A-/BBB+) | 0 | 稳定 | 🟢(平静) | 0 |
...
|------|-------------|------------------|------|-------|---------|------|
| 交通运输 | 2.0-3.0 (B+/B) | 3 | 负面 | 🔴(危机) | 4.0 | 客运量锐减，航空公司日亏数亿 |
| 商贸零售 | 2.5-3.5 (B/B+) | 2 | 负面 | 🔴(危机) | 3.0 | 百货/购物中心客流归零 |
| 传媒/互联网 | 3.0-4.0 (BB/B+) | 2 | 负面 | 🟠(异常) | 3.0 | 广告收入骤降，但线上消费受益 |
| 食品饮料 | 3.5-4.5 (BB/B+) | 2 | 负面 | 🟠(异常) | 3.0 | 餐饮/礼品消费骤降，但必选消费受益 |
| 纺织服装 | 2.5-3.5 (B/B+) | 2 | 负面 | 🟠(异常) | 3.0 | 线下门店关闭，出口订单取消 |
| 房地产 | 3.0-4.0 (BB-/B+) | 2 | 负面 | 🟠(异常) | 3.0 | 售楼处关闭，销售回款冻结 |
| 新能源车 | 3.5-4.5 (BB/B+) | 2 | 负面 | 🟠(异常) | 3.0 | 工厂停工，销量暴跌80%+ |
| 光伏/储能 | 4.0-5.0 (BB+/B+) | 2 | 负面 | 🟡(关注) | 2.5 | 产能利用率下降，海外订单延迟 |
| 高端装备 | 4.0-5.0 (BB+/B+) | 2 | 负面 | 🟡(关注) | 2.5 | 生产暂停，交付延期 |
| 医疗器械 | 5.0-6.0 (BBB/BB+) | 1 | 正面 | 🟢(平静) | 1.0 | 抗疫物资需求暴增，受益行业 |
| 生物医药 | 5.5-6.5 (BBB+/A-) | 0 | 正面 | 🟢(平静) | 0 | 抗疫相关研发受益，非疫情领域受影响 |
| 城投债(LGV) | 5.0-6.0 (BBB/BB+) | 1 | 稳定 | 🟡(关注) | 1.5 | 基建稳增长预期升温，但短期有压力 |
| 半导体/集成电路 | 5.5-6.5 (BBB+/A-) | 0 | 正面 | 🟡(关注) | 0.5 | 供应链中断担忧但国产替代逻辑强化 |
...
|------|-------------|-------|------|-------|---------|---------|
| 光伏/储能 | 4.5-5.5 (BB+/BBB-) | 2 | 负面 | 🟡(关注) | 2.5 | 产能过剩·供需错配·景气度低位（兴业研究） |
| 半导体/集成电路 | 6.5-7.5 (A-/A) | 0 | 正面 | 🟢(平静) | 0 | 新兴产业高增长·股权财政外溢效应（国投证券） |
| 高端装备/工业母机 | 6.0-7.0 (A-/BBB+) | 0 | 稳定 | 🟢(平静) | 0 | 科创央国企估值下行+高端制造需求稳定 |
| 生物医药/创新药 | 5.5-6.5 (BBB+/A-) | 0 | 稳定 | 🟢(平静) | 0 | Biotech融资回暖但分化仍存 |
| 医疗器械 | 6.0-7.0 (A-/BBB+) | 0 | 稳定 | 🟢(平静) | 0 | 集采压力持续但国产替代支撑 |
| 新能源汽车 | 5.0-6.0 (BBB/BB+) | 1 | 负面 | 🟡(关注) | 2.0 | 价格战持续·产能过剩·尾部出清 |
| 数据中心/算力基建 | 6.5-7.5 (A-/A) | 0 | 正面 | 🟢(平静) | 0 | AI算力需求爆发·景气度高企 |
| 城投债(LGV) | 5.0-5.5 (BB+/BBB) | 1 | 稳定 | 🟡(关注) | 1.5 | 化债推进中·区域分化加剧·评级下调集中（财通证券） |
| 食品饮料 | 6.5-7.5 (A-/A) | 0 | 稳定 | 🟢(平静) | 0 | 消费稳定·必选消费抗周期 |
| 纺织服装 | 5.5-6.5 (BBB+/A-) | 0 | 稳定 | 🟢(平静) | 0 | 出口有韧性·内需偏弱 |
| 交通运输 | 5.5-6.5 (BBB+/A-) | 0 | 稳定 | 🟢(平静) | 0 | 物流/交运需求平稳 |
| 商贸零售 | 5.0-6.0 (BBB/BB+) | 1 | 负面 | 🟡(关注) | 2.0 | 消费降级·线上冲击·部分企业承压 |
| 传媒/互联网 | 5.5-6.5 (BBB+/A-) | 0 | 稳定 | 🟢(平静) | 0 | 广告收入恢复·监管环境平稳 |

### 8.2 各行业风险得分详细说明

| 行业 | 风险得分 | 详细说明 |
|------|---------|---------|
| **光伏/储能** | 2.5 | 基准分2（轨道A 4.5-5.5，BB+/BBB-区间）+ 展望负面0.5。产能严重过剩是核心矛盾，全产业链面临供给侧出清压力 |
| **新能源汽车** | 2.0 | 基准分1（轨道A 5.0-6.0，BBB/BB+区间）+ 展望负面0.5 + 轨道B异常0.5。价格战持续·尾部出清加速·但电池板块企稳回升 |
| **城投债(LGV)** | 1.5 | 基准分1（轨道A 5.0-5.5，BB+/BBB区间）+ 轨道B关注0.5。10万亿化债推进中，但弱区域（山东/陕西/云南/河南等）评级下调集中 |
| **商贸零售** | 2.0 | 基准分1（轨道A 5.0-6.0，BBB/BB+区间）+ 展望负面0.5 + 轨道B关注0.5。消费降级趋势·线上线下融合压力·部分民企承压 |

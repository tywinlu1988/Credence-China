...
**版本**: v0.12.3-release | **日期**: 2026-07-16
...
dimensions:
  - id: paradigm-A
    name: 政策驱动型
    letter: A
    definition: 政策驱动型 (engine/industry-framework.md §三)
    standalone_doc: embedded in engine/industry-framework.md §三（判定）与 §四（金字塔权重）
  ...
  - id: paradigm-B
    name: 技术壁垒型
    letter: B
    definition: 技术壁垒型 (engine/industry-framework.md §三)
    standalone_doc: embedded in engine/industry-framework.md §三（判定）与 §四（金字塔权重）
  ...
  - id: paradigm-C
    name: 存量博弈型
    letter: C
    definition: 存量博弈型 (engine/industry-framework.md §三)
    standalone_doc: embedded in engine/industry-framework.md §三（判定）与 §四（金字塔权重）
    industries: [新能源汽车]
    used_by_paths: [WP-M0-01, WP-M1-02, WP-X-02, WP-X-03]
  ...
  - id: paradigm-D
    name: 资产租约型
    letter: D
    definition: 资产租约型 (engine/industry-framework.md §三)
    standalone_doc: embedded in engine/industry-framework.md §三（判定）与 §四（金字塔权重）
  ...
  - id: paradigm-E
    name: 品牌+渠道型
    letter: E
    definition: 品牌+渠道型 (engine/paradigm-brand-channel.md §一)
    standalone_doc: engine/paradigm-brand-channel.md
  ...
  - id: paradigm-F
    name: 网络+流量型
    letter: F
    definition: 网络+流量型 (engine/paradigm-network-traffic.md §一)
    standalone_doc: engine/paradigm-network-traffic.md
  ...
  - id: lgfv
    name: 政府信用绑定型
    letter: 特殊
    definition: 政府信用绑定型 (engine/industry-framework.md §七)
    standalone_doc: engine/lgfv-framework.md
    industries: [城投债 / LGFV]
    used_by_paths: [WP-M0-01, WP-M1-02, WP-X-02, WP-X-03]
```
...
roles:
  - id: role-M0
    name: 审贷
    definition: 信贷审批 (engine/multi-stakeholder.md §一)
    used_by_paths: [WP-M0-01, WP-M0-02]

  - id: role-M1
    name: 投资
    definition: 债券投资 (engine/multi-stakeholder.md §一)
    used_by_paths: [WP-M1-01, WP-M1-02]

  - id: role-M2
    name: 承销
    definition: 债券承销 (engine/multi-stakeholder.md §一)
    used_by_paths: [WP-M2-01]

  - id: role-M3
    name: 交易
    definition: 市场交易 (engine/multi-stakeholder.md §一)
    used_by_paths: [WP-M3-01]

  - id: role-M4
    name: 风控
    definition: 组合风控 (engine/multi-stakeholder.md §一)
    used_by_paths: [WP-M4-01, WP-M4-02, WP-M4-03, WP-M4-04]

  - id: role-M5
    name: 融资
    definition: 企业融资 (engine/multi-stakeholder.md §一)

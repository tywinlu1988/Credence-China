...
> 本文自 `fixed-income-credit-analysis` SKILL.md 下沉而来，组织系统智能层（跨行业传染 / 五维集中度 / 系统性风险指数）内容。算法与阈值的单一事实源为 `engine/systemic-warning-framework.md`、`engine/contagion-matrix.md`、`engine/concentration-framework.md`；本文件仅作导航与组织，不引入新数值。
...
- **Contagion matrix**: 13×13 industry intensity matrix with direction, confidence, and upgrade-factor linkage. See `engine/contagion-matrix.md`.
...
For full specification see `engine/systemic-warning-framework.md`.

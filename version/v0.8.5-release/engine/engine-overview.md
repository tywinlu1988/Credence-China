...
**版本**: v0.8.5-release | **日期**: 2026-07-10
...
| 版本体系 | 适用范围 | 示例 | 说明 |
|---|---|---|---|
| **引擎版本** | 核心方法论文档 | v0.8.5-release | 反映引擎方法论的整体迭代阶段，所有核心方法论文档统一标注此版本 |
...
| 文档 | 当前版本 | 说明 |
|---|---|---|
| engine-overview.md | v0.8.5-release | 引擎架构总览 |
| dual-track-methodology.md | v0.8.5-release | 双轨分析方法论 |
| industry-framework.md | v0.8.5-release | 行业分类与分析框架 |
| qualitative-analysis.md | v0.8.5-release | 定性分析方法论 |
| quantitative-analysis.md | v0.8.5-release | 定量分析方法论 |
| mosaic-engine.md | v0.8.5-release | 马赛克引擎 |
| output-layered-framework.md | v0.8.5-release | 分层输出框架 |
| contagion-theory.md | v0.8.5-release | 传染理论基础（系统智能层） |
| contagion-matrix.md | v0.8.5-release | 13行业传染矩阵 |
| concentration-framework.md | v0.8.5-release | 五维集中度分析框架 |
| systemic-warning-framework.md | v0.8.5-release | 系统性预警框架 |
| validation-methodology.md | v0.8.5-release | 黑天鹅回溯验证方法论 |
| financial-bond-framework.md | v0.8.5-release | 金融债分析框架 |
| holding-company-framework.md | v0.8.5-release | 控股公司信用分析框架 |
| non-credit-risk-overlay.md | v0.8.5-release | 非信用风险叠加层 |
| external-support-framework.md | v0.8.5-release | 外部支持评估框架 |
| esg-framework.md | v0.8.5-release | ESG 与治理风险框架 |
| governance-fraud-risk.md | v0.8.5-release | 治理/欺诈风险框架 |
| outlook-monitoring-framework.md | v0.8.5-release | 展望与持续监控框架 |
| lgd-recovery-framework.md | v0.8.5-release | LGD 与回收率分析框架 |
| lgfv-framework.md | v0.8.5-release | 城投债分析框架 |
| multi-stakeholder.md | v0.8.5-release | 多利益相关者框架 |
| financial-deep-dive.md | v0.8.5-release | 财务深度分析框架 |
| paradigm-brand-channel.md | v0.8.5-release | 品牌+渠道范式规格 |
| paradigm-network-traffic.md | v0.8.5-release | 网络+流量范式规格 |
| work-path-registry.md | v0.8.5-release | 工作路径注册表 |
| dimension-registry.md | v0.8.5-release | 维度注册表 |
| pipeline-contract.md | v0.8.5-release | 四段链产物契约 |

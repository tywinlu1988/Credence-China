...
\* 口径标注：15.2% 为**转股价值口径** = (转债价格 − 转股价值) / 转股价值；市场惯用报价的 74% 为**面值口径**（基于面值100元的简化计算），仅是交易报价指标，不作信用警报依据——归并自 quantitative-analysis.md §7.3，v0.11.2 起为单一事实源。
...
🔴 红色（高优先级，需24小时内关注）
  1. 隆22转债已触发回售条款保护价（转股溢价率15.2%，转股价值口径；74%为面值口径报价指标，不作信用警报依据——见 multi-stakeholder.md §2.2 转股溢价率口径约束）
...
\* 口径标注：市场惯用报价的 74% 为面值口径（基于面值100元的简化计算），不作信用警报依据；信用语境以转股价值口径为准——见 multi-stakeholder.md §2.2 转股溢价率口径约束。
...
【条款分析】                  ╔══════════════╗
  ✓ 回售保护(转股溢价率15.2%*)  ║ 条款综合评分:  ║
  ✓ 交叉违约条款                ║    7/10      ║
  ✓ 担保: 无                   ╚══════════════╝
  ✗ 无担保物
  ✗ 无偿债基金
  * 转股价值口径=(转债价格-转股价值)/转股价值；市场惯用报价74%为面值口径（基于面值100元），不作信用警报依据（见 multi-stakeholder.md §2.2 转股溢价率口径约束）
...
关键异常:
  🔴 隆22转债回售触发（转股溢价率15.2%，转股价值口径；74%为面值口径） ✓ (持续,不变)

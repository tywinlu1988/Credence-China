...
**版本**: v0.9.3-release | **日期**: 2026-07-10 | **状态**: 已发布
...
| v0.9.3-release（当前） | 文档一致性修复（本框架含 §2.1 表头 12档→18档、§11.3 未来行重编号至 v0.10.3） |
...
*本文档应与《双轨分析方法论》(v0.9.3-release)、《传染矩阵》(v0.9.3-release)、《五维集中度分析框架》(v0.9.3-release)、《展望监控框架》配合使用。系统性预警框架是引擎M4组合风控层的顶层仪表盘，为分散的行业信号提供统一的系统性风险读数。*

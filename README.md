...
- **v0.12.0（规划中）**：编码引擎扩线首波——WP-M0-02 双引擎（LGD 评估 + 外部支持评估）接线，确定性+可审计。
...
- **v0.12.0 (planned)**: coded-engine expansion wave 1 — WP-M0-02 dual engines (LGD + external support), deterministic and auditable.

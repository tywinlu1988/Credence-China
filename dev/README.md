...
**项目代号**: Credence
**版本**: v0.12.1-release
**状态**: 正式发布（v0.12.x 编码化系列进行中） · 16/16 全 active · 29 引擎文档 · 7 编码引擎 · 16 模板装配化 · 四段链技能交付
...
可执行编排器（`../src/pipeline.py`）+ 7 个编码引擎已接线（6 条路径：WP-M0-01/WP-M0-02/WP-M4-01/-02/-03/WP-X-05），CI 双门在线；剩余扩展见根 README 路线图。
...
| 可执行编排器（v0.7.8：以代码驱动四段链，接 WP-M0-01/WP-M0-02/WP-M4-01/-02/-03/WP-X-05 六条路径、七个编码引擎） | `../src/pipeline.py` |

...
根据《传染理论基础》(v0.7.0-alpha)定义的6种分析范式，将13个行业映射至对应范式。同一范式内的行业因共享相同的风险驱动因子、融资特征和市场叙事逻辑，**先天性具有更高的传染耦合度**。
...
| 8 | 城投债(LGV) | **特殊：政府信用绑定型** | — | 地方政府信用背书·区域财政决定信用·基础设施投资载体 | 极高(金融工具属性) | 100%(地方政府平台) |
...
| **特殊** (政府信用绑定型) | 城投债(LGV) | 通过区域财政和基础设施投资与多行业广泛连接；不强制归入六范式 |
...
| 城投债(LGV) | → 交通运输(基建) | 4 | 城投是交运基建投融资主体 |

#### 原则3：同区域依赖传导强度高

城投债(LGV)作为信用绑定区域财政的特殊行业，通过以下机制向多行业传导：
...
| **集群C** | 政府基建-交运联合 | 城投债(LGV)、交通运输 | 城投债↔交通运输(4) | 区域共振+信用链 |
...
| **2** | **城投债(LGV)** | **24** | 交通运输(4)·光伏(3)·数据中心(3) | 区域信用绑定+基建融资枢纽·通过区域共振向多行业传导 |
...
| **2** | **城投债(LGV)** | **24** | 交通运输(4)·光伏(3)·数据中心(3) | 区域信用链条中的被动受体·多行业违约均可传导至城投 |
...
| 2 | 城投债(LGV) | 24 | 交通运输·光伏·数据中心·新能源车 |

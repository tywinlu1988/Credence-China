...
归并自 quantitative-analysis.md §6.2-6.5（华晨回溯案例精简为结论指针），v0.11.2 起本节为单一事实源。
...
**回溯验证结论**（17华汽05，分析日2018-12-31，T-22个月回溯验证案例）：方向性准确——"宝马剥离情景"预判母公司信用重定价（YTM 7.5%→12.0%、价格影响-10.8%），现实为2020-10首次违约、无担保债权回收率约30-40%（预测40%，基本准确）；但违约前二级市场YTM实际到20%+——低估了恐慌程度，流动性溢价未被充分计入。完整情景构建与数据表见 quantitative-analysis.md §6.5。

...
| 维度 | 光伏/储能 | 半导体 | 高端装备 | 生物医药 | 医疗器械 | 新能源车-OEM | 新能源车-供应链 | 数据中心 | 食品饮料 | 纺织服装 | 交通运输 | 商贸零售 | 传媒/互联网 | 城投债(LGV) |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
| 城投债(LGV) | 5 | 1 | 4 | 4 | 3 | 4 | 1 | 3 | 2 | 3 | 特殊：政府信用绑定型 |
...
- **城投债(LGV)**：D1 大市场（债券存量）、D3/D4 高反映政策与化债周期、D6 高体现基础设施民生属性。LGFV 并非普通行业，不强制归入六范式，单列特殊类别。
...
| 城投债(LGV)(LGFV) | 特殊：政府信用绑定型 | — | 不强制归入六范式；信用绑定地方政府财政 |

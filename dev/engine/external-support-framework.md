...
|------|---------|---------|----------|------------|----------|------------|
| 母公司独立信用质量 | 使用本引擎对其他集团进行独立评估，排除子公司贡献后的实力 | 集团合并报表+母公司单体报表 | AAA/AA+ | AA/AA-/A+ | A/BBB+/BBB | BBB-及以下或无评级 |
...
| 指标 | 评估方法 | 数据来源 | 强（3分） | 中等（2分） | 弱（1分） | 极弱（0分） |
|------|---------|---------|----------|------------|----------|------------|
| 战投自身信用评级 | 使用本引擎或外部评级评估战投本身 | 外部评级/公开财报 | AAA/AA+ | AA/AA-/A+ | A/BBB+ | BBB及以下 |

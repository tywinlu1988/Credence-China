...
| v0.7.1-release (当前) | 系统智能层整合：与传染矩阵/集中度框架形成完整M4组合风控体系，引擎版本统一 |
...
*本文档应与《双轨分析方法论》(v0.7.1-release)、《传染矩阵》(v0.7.1-release)、《五维集中度分析框架》(v0.7.1-release)、《展望监控框架》配合使用。系统性预警框架是引擎M4组合风控层的顶层仪表盘，为分散的行业信号提供统一的系统性风险读数。*

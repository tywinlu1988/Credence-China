...
**版本**: v0.10.4-release | **日期**: 2026-07-10 | **状态**: 已发布
...
| v0.10.4-release（当前） | 沙箱审计修复：生成器计数动态化/多事实源一致性/入口文档充实/状态行系列完结（v0.10.x 系列收尾）（本框架与阈值无变更） |
...
*本文档应与《双轨分析方法论》(v0.10.4-release)、《传染矩阵》(v0.10.4-release)、《五维集中度分析框架》(v0.10.4-release)、《展望监控框架》配合使用。系统性预警框架是引擎M4组合风控层的顶层仪表盘，为分散的行业信号提供统一的系统性风险读数。*

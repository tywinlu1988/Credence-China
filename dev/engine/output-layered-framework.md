...
🔴 红色（高优先级，需24小时内关注）
  1. 隆22转债已触发回售条款保护价（转股溢价率15.2%，转股价值口径；74%为面值口径报价指标，不作信用警报依据——quantitative-analysis.md §7.3）
...
\* 口径标注：市场惯用报价的 74% 为面值口径（基于面值100元的简化计算），不作信用警报依据；信用语境以转股价值口径为准——见 quantitative-analysis.md §7.3。
...
【条款分析】                  ╔══════════════╗
  ...
  ✗ 无担保物
  ✗ 无偿债基金
  * 转股价值口径=(转债价格-转股价值)/转股价值；市场惯用报价74%为面值口径（基于面值100元），不作信用警报依据（quantitative-analysis.md §7.3）

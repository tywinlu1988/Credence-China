...
> 🔴 一票否决级条件的权威定义见 [industry-framework.md](industry-framework.md) §五（单一事实源）；本表为各信号补充信源级别与预警窗口，不复制否决条件文本。

| 行业 | 红旗信号 | 信源级别 | 预警窗口 | 严重程度 |
|------|---------|---------|---------|---------|
| **光伏** | 技术路线被淘汰（否决条件见 industry-framework §五） | 企业披露(L2) | 12-24个月 | 🔴 一票否决 |
| | 央企集采未入围或份额持续下降 | 招标公告(L6-L5) | 6-12个月 | 🟠 重大 |
| | 应收账款周转天数连续3季度上升 | 季报(L2) | 3-6个月 | 🟡 关注 |
| **半导体** | 被列入实体清单或SDN清单 | 美国商务部(L6) | 0（即时） | 🟠 重大（触发制裁影响专项评估，见 industry-framework §5.1） |
...
| **高端装备** | 核心部件全部外采无国内替代（否决条件见 industry-framework §五） | 技术拆解+年报(L4/L2) | 12-24个月 | 🔴 一票否决 |
| | R&D资本化率>40% | 年报(L2) | 12-24个月 | 🟠 重大 |
| | Q4收入占比>40%持续2年 | 年报(L2) | 6-12个月 | 🟡 关注 |
| **生物医药** | 核心管线临床失败（否决条件见 industry-framework §五） | 公司公告(L2) | 即时 | 🔴 一票否决 |
| | 现金跑道<6个月且无新的BD首付款 | 财报(L2) | 3-6个月 | 🔴 生存性 |
| | FDA/NDA审批被拒或延迟 | FDA公告(L6) | 即时 | 🟠 重大 |
| **数据中心** | 核心客户租约不续约（否决条件见 industry-framework §五） | 公司披露(L2) | 6-12个月 | 🔴 一票否决 |
| | 上架率连续2季度下降 | 公司披露(L2) | 6-12个月 | 🟠 重大 |
| | PUE持续高于同行0.15+ | 行业报告(L4/L5) | 12-24个月 | 🟡 关注 |
| **医疗器械** | 注册证到期无法续期（否决条件见 industry-framework §五） | 药监局官网(L6) | 0-12个月 | 🔴 一票否决 |
